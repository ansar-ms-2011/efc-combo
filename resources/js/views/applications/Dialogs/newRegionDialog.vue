<script setup lang="ts">
    ...
    const validationSchema = yup.object({
        ...
        urdu_name: yup.string().required('علاقے کا نام ضروری ہے'),
        code: yup.string().nullable(),
        parent_id: yup.string().nullable(),
        status: yup.string().nullable(),
        type: yup.string().default('REGION')
    });
...
<template>
    <BaseDialog v-model="showAddDialog" title="نیا علاقہ شامل کریں" class="font-nastaleeq">
        ...
        >
            <div class="space-y-4 p-4" dir="rtl">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        علاقے کا نام <span class="text-red-500">*</span>
                    </label>
                    <Field
                        name="urdu_name"
