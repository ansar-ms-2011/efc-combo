    ...
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
        <div
            ...
            <div class="relative">
                ...
                <p class="text-base dark:text-white">You do not have permission to access this page!</p>
                <router-link to="/"
                    class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Home</router-link>
            </div>
        </div>
    </div>
</template>
