            ...
            <div
                ...
                <div class="relative w-full px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    <div class="mx-auto mt-5 w-full max-w-[550px] lg:mt-16">
                        ...
                        <div class="mb-12">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Coming
                                Soon</h1>
                        ...
                        <div class="mb-20 md:mb-32">
                            <h2 class="text-lg font-bold uppercase dark:text-white sm:text-xl">Subscribe to get
                                notified!</h2>
